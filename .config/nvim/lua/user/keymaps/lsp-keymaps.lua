...
M.on_attach_keymaps = function(client, bufnr)
	...
	wk.addWkKey("n", "K", nil, "<cmd>lua vim.lsp.buf.hover()<CR>", opts)
	...
	wk.addWkKey("n", "<Leader>lh", "Previous Diagnostic", "<cmd>lua vim.diagnostic.goto_prev(opts)<cr>", opts)
	wk.addWkKey("n", "<Leader>ll", "Next Diagnostic", "<cmd>lua vim.diagnostic.goto_next(opts)<cr>", opts)
